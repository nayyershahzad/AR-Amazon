...
export class AutomationHandler {
   ...
   */
  async setupAutomation(req: Request, res: Response) {
    try {
   ...
   */
  async generatePaymentPlan(req: Request, res: Response) {
    try {
   ...
   */
  async schedulePayments(req: Request, res: Response) {
    try {
   ...
   */
  async getAutomationStatus(req: Request, res: Response) {
    try {
   ...
   */
  async analyzeCashFlow(req: Request, res: Response) {
    try {
      const { userId } = req.params;
   ...
   */
  async simulateExecution(req: Request, res: Response) {
    try {
